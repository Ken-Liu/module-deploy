...
exports.restart = function(config) {
  ...
  var virtual_host = config.virtual_host;
...
function startAndVerify(taskList, appName, port, deployCheckWaitTime , meteor_container_port, mongodb_URL) {
...
function deployAndVerify(taskList, appName, port, deployCheckWaitTime , meteor_container_port , mongodb_URL) {
  // deploying
